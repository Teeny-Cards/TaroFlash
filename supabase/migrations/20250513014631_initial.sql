...
CREATE TABLE IF NOT EXISTS "public"."cards" (
    ...
    "ease" smallint DEFAULT '1'::smallint,
    "interval" smallint DEFAULT '1'::smallint,
    "order" smallint NOT NULL,
    "state" "public"."card_state" DEFAULT 'new'::"public"."card_state"
);
...
ALTER TABLE "public"."cards" ALTER COLUMN "order" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."cards_order_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
GRANT ALL ON SEQUENCE "public"."cards_order_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cards_order_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cards_order_seq" TO "service_role";
