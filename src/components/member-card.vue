<template>
  <div
    member-card
    class="bg-brown-300 rounded-8 shadow-modal border-brown-100-dark flex w-89 flex-col overflow-hidden
      border-8"
  >
    ...
    >
      <div member-card__avatar class="flex h-full flex-col justify-center">
        <div class="bg-brown-300 rounded-19 border-brown-100-dark h-50 w-50 border-10"></div>
      </div>
      <div
        class="bg-brown-300 rounded-1_5 text-brown-700 ring-brown-100-dark w-full text-base ring-8"
      >
        {{ description }}
      </div>
